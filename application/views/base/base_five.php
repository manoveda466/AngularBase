    ...
    <body>
        <div class="preloader" id="load_screen">
            <div class="loader">
              ...
              <div class="loader__label"><img src="<?php echo base_url(); ?>global/assets/images/logo.png" alt="" height="50"></div>
            </div>
        </div>
        ...
        <header id="topnav">
            <div class="topbar-main">
                <div class="container-fluid">
                    <!-- Logo container-->
                    <div class="logo">                        
                         <a href="<?php echo base_url(); ?>" class="manufacturing"><img src="<?php echo base_url('global/assets/images/logo.png'); ?>" height="40"></a>
                    </div>
                    <!-- End Logo container-->
