                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                               <!-- <a href="<?php echo base_url(); ?>" class="text-dark">
                                ...
                                <img src="<?php echo base_url('global/assets/images/logo.png'); ?>" height="50">
                            </h2>
<?php
...
<!-- Begin page -->
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright"><?php echo date('Y'); ?> &copy; <?php echo $this->dbvars->app_name;?>. All rights reserved.</p>
            </div>
