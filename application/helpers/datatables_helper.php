...
function get_angular_button($id, $url)
{
    $ci      = & get_instance();
    $deleteUrl  = base_url($url.'/delete/'.$id);

    $html    = '<span class="actions">';
    $html   .= '<a class="editButtonClick" data-form_url="'.base_url().$url.'edit/'.trim($id).'" title="Edit"><i class="os-icon os-icon-pencil-2" style="font-size:15px;"></i></a>';
    $html   .= '&nbsp;&nbsp;';
